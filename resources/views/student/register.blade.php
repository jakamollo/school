            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('post_student_reg') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <input name="type" type="text" value="student" hidden>

    ...
    <div class="modal_header">
        ...
        <div class="modal_body">
            ...
            <div class="subj_form_group">
                ...
                <div>
                    {!! Form::select('grading_choice', ['a' => 'A','b' => 'B','c' =>'C'],['class' => '', 'id' => 'new_subj_grading', 'required']) !!}
                </div>
            </div>
            {{-- category div--}}
            <div class="subj_form_group">
                ...
                <div>
                    {!! Form::select('category', ['mandatory' => 'Mandatory', 'sciences' => 'Sciences', 'humanities' => 'Humanities', 'applied' => 'Applied'],['class' => '','id' => 'new_subj_category', 'required']) !!}
                </div>
            </div>
            {{-- Length in weeks div --}}
            <div class="subj_form_group">
        ...
        <div class="modal_footer">
            ...
            <div class="subj_submit_btn">
                <button type="submit" class="btn btn-primary submit_subj">Submit</button>
            </div>
            {{-- close button --}}

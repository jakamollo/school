        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Register As Staff</div>
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('post_staff_reg') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <input name="type" type="text" value="staff" hidden>
                            <input name="confirmed" type="text" value="yes" hidden>
